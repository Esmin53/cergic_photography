  ...
  return (
    <MaxWidthWrapper background_color={null}>
      <div className='flex flex-col w-full h-full'>
        ...
        <div className={`flex w-full py-2 gap-4 h-full ${inverted ? "flex-row" : "flex-row-reverse"}`}>
          <div className='grid grid-cols-3 gap-1.5 w-full max-w-4xl'>
          ...
          <div className='flex-1 relative'>
            <Image src={banner} fill alt='' className='rounded-xl object-cover'/>
          </div>
        </div>
      </div>
