...
const AboutMe = () => {
  return (
    <MaxWidthWrapper background_color={null}>
        <div className='w-full flex py-12 font-mono h-fit gap-12 z-10' >
            <div className='flex-1 flex flex-col gap-2'>
                <p className='text-3xl font-bold'>Majid Čergić - Fotograf</p>
            ...
            <div className='w-full flex'>
                <div className='flex flex-col gap-2'>
                    <div className='flex items-center gap-2'>
                        ...
                        <p className='text-md'>Banovići</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <FaInstagram className='text-xl'/>
                        <p className='text-md'>Cergicphotography</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <FaCameraRetro className='text-xl'/>
                        <p className='text-md'>Canon smth</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <FaPhone className='text-xl'/>
                        <p className='text-md'>062 555 232</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <FaPinterest className='text-xl'/>
                        <p className='text-md'>Pinterest</p>
                    </div>
                </div>
            </div>
            ...
            <div className='w-2/5 h-96 relative group'>
                <div className='w-full h-full absolute top-5 -left-5 bg-foreground rounded'/>
