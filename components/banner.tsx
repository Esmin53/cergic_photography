        ...
        <div className='w-full bg-foreground flex items-center relative pt-8 pb-12 sm:pb-16'>
            <div className='flex flex-col sm:flex-row flex-1 mt-auto gap-8 relative px-2 lg:px-4'>
                ...
                <div className='flex-1 aspect-square flex relative group'>
                    ...
                    <p className='text-4xl sm:text-5xl font-semibold sm:font-bold font-script absolute sm:-bottom-6 sm:left-1/2 sm:-translate-x-1/2  pointer-events-none cursor-pointer -top-5 left-1/2 -translate-x-1/2 text-text'>
                        Weddings
                    </p>
                </div>
                <div className='flex-1 aspect-square flex  relative group'>
                    ...
                    <p className='text-4xl sm:text-5xl font-semibold sm:font-bold font-script absolute left-1/2 -translate-x-1/2 bottom-1/2 translate-y-1/2 dark:text-text text-[#fff]'>Portraits</p>
                </div>
                <div className='flex-1 aspect-square flex  relative group'>
                    <div className='flex-1 relative rounded-lg overflow-hidden'>
